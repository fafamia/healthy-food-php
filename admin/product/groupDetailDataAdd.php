...
try {
    ...
    // 檢查所需的鍵是否已設定
    if (isset($_POST["prodgroup_name"]) && isset($_POST["product_names"]) && isset($_POST["prodgroup_name"]) && isset($_POST["prodgroup_sale_price"])) {
        // 解析以逗號分隔的商品編號字符串為陣列
        ...
        foreach ($product_names as $product_name) {
            ...
            $groupdetails->bindParam(":product_name", $product_name); // 使用循環中的每個商品編號
